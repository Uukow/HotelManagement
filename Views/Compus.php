...
<div class="content-page">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Compus Data Table</h4>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <button id="AddNew" class="btn btn-primary float-end">Add New Compus</button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane show active" id="basic-datatable-preview">
                                    <table id="CompusTable" class="table table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <!-- <th>#</th> -->
                                                <th onclick="sortTable(0)">#</th>
                                                <th onclick="sortTable(1)">Compus Name</th>
                                                <th onclick="sortTable(2)">Compus Location</th>
                                                <th onclick="sortTable(3)">Compus Phone</th>
            ...
            <div class="modal" tabindex="-1" id="CompusModal">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Compus Registration</h5>
    ...
    <script src="../js/Compus.js"></script>

    <script>
        function sortTable(columnIndex) {
            const table = document.getElementById('CompusTable');
