...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active" id="basic-datatable-preview">
                                    <table id="teamsTable" class="table table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
            ...
            <div class="modal" tabindex="-1" id="teamsModal">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="stId" id="stId" class="form-control" value="" required>
                                        </div>
