                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane show active" id="servicesTable-preview">
                                    <table id="servicesTable" class="table table-striped dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <!-- <th>#</th> -->
                                                <th onclick="sortTable(0)">ID</th>
                                                <th onclick="sortTable(1)">Service ID</th>
                                                <th onclick="sortTable(2)">Category Name</th>
                                                <th onclick="sortTable(3)">Service Name</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Service Registration</h5>
                            ...
                            <form id="servicesForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" name="serviceId" id="serviceId" class="form-control" value="" required>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="">Sevice Name</label>
                                            <input type="text" name="serviceName" id="serviceName" class="form-control" value="" required>
                                        </div>
                                    </div>
